...
<h3 align="center">
  Software Engineer · Golang · Next.js · Flutter
</h3>

<p align="center">
  Building scalable backends, modern web apps and cross-platform mobile experiences.
</p>
...
- 🔭 Currently working with **Golang microservices, Next.js (React) and Flutter**
- 🧠 Focused on **clean architecture, performance and scalability**
- ⚙️ Interested in **backend systems, cloud-native apps and distributed architectures**
- 👨‍💻 All my projects are available at  
  👉 [github.com/DannyStrelok](https://github.com/DannyStrelok?tab=repositories)
- 📫 Reach me at **hmartindaniel@gmail.com**
